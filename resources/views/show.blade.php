...
@section('content')
                        ...
                        <div x-data ="{ isOpen: false}">
                            @if(count($show['videos']['results']) > 0)
                                <div class="mt-12">
                                    ...
                                    <button
                                        @click="isOpen = true"
                                        class="flex inline-flex items-center bg-red-500 text-gray-900 round font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150"
                                    >
                                ...
                                <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                                    <div class="bg-gray-900 rounded">
                                        <div class="flex justify-end pr-4 pt-2">
                                            <button
                                              @click="isOpen = false"
                                              class="text-3xl,loading-none hover:text-gray-300">&times;
     ...
     <div class="movie-images" x-data="{ isOpen: false, image: ''}">
        <div class="container max-auto px-4 py-16">
            <h2 class="text-4xl font-semibold text-gold-500">Images</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:cols-3 gap-8">
                @foreach ($show['images']['backdrops'] as $image)
                       @if ($loop->index < 8)
                           <div class="mt-8">
                               ...
                               @click.prevent=
                               "isOpen = true
                               image='{{'https://images.tmdb.org/t/p/original/'.$image['file_path']}}'
                               "
                                 href="#"
                               >
                                   <img src="{{ 'https://images.tmdb.org/t/p/w500/'.$image['file_path']}}" alt="" class="hover;opacity-75 trainsition ease-in-out duration-150">
                               </a>
                           </div>
                       @endif
                @endforeach
