                  ...
                  <div class="flex-none">
                   ...
                   <div class="ml-24">
                       ...
                       @if (count($show['videos']['results'])> 0)
                        <div class="mt-12">
                           <a href="https://youtube.com/watch?v={{ $show['videos']['results'][0]['key'] }}"
                           class="flex inline-flex items-center bg-red-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-red-600
